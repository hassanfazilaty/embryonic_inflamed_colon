...
VlnPlot(E14_5_dev_std, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3)
VlnPlot(E15_5_dev_std, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3)
VlnPlot(E18_5_dev_std, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3)
